...
public class SimulationTests
{
    ...
    public void TransferFromEntity_MoreThanPlayerCanHold_ClampsWithoutLosingItems()
    {
        ...
        // 玩家背包 60 槽。开局物资包(data/base/player.json):
        ...
        // (60 - 7 起始槽 = 53 个空槽;补满半满槽需要 100-8=92 -- 铁板 stackSize
        // 实际是 50,数值以 ironStack 为准,再填满 53 个满槽需要 53*ironStack),
        // 让玩家背包里除了那个半满的 coal 槽以外,再没有任何空间——这样转移煤时
        // 第二轮(占空槽)完全没有名额,只有第一轮(补 coal 半满槽的 30 个空间)能接收。
